...
Create a subfolder called `data` in the folder you just created in Exercise 1. Download the data for next week's lab (Lab 2) from the course website and put it in the data folder.
