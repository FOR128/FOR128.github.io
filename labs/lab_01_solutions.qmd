...
Now, the files in the `data` subdirectory are listed. 
...
Here, we see a .rmarkdown temporary file appear. The student need not have great intuition about this, just observe that it appears and attempt to explain why it might be there.
...
The students should notice that the number of bins increases as bins increases. 
