...
Write a function that takes the absolute value of the difference of the medians of two vectors. You function should allow the user to choose to remove NAs or not. Make sure to add a check in your function that the vectors are numeric (and an informative error that if they are not), as well. 
